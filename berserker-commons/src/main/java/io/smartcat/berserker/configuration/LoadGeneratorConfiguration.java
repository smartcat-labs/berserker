...
public class LoadGeneratorConfiguration {
    ...
    /**
     * Name of {@link io.smartcat.berserker.api.DataSource DataSource} configuration.
     */
    public String dataSourceConfigurationName;

    /**
     * Name of {@link io.smartcat.berserker.api.RateGenerator RateGenerator} configuration.
     */
    public String rateGeneratorConfigurationName;

    /**
     * Name of {@link io.smartcat.berserker.api.Worker Worker} configuration.
     */
